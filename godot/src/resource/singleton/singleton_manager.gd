...
const DB = preload("res://data/singleton_db.tres")
...
var data = {
	"state":
	{
		"creating_singletons": false,
		"adding_singletons": false,
		"checking_singletons": false,
		"retreiving_singletons": false,
		"removing_singletons": false
	}
}


static func from_script(_script: Script):
	var db = DB.get_cache()
